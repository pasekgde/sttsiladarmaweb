    ...
    <div class="col-12">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-0">Pilih Kegiatan</h5>
                    <small>Pilih kegiatan yang akan diinput</small>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    @if ($keg->status == 'Belum')
                                        <a href="{{ url('/pilihevent/'.$keg->id) }}" class="btn btn-success btn-sm">
                                            <i class="fa fa-check-circle"></i> Silakan Lakukan Pengolahan Data
                                        </a>
                                    @else
                                        <a href="{{ url('/pilihevent/'.$keg->id) }}" class="btn btn-primary btn-sm">
                                            <i class="fa fa-download"></i> Lihat Hasil Pengolahan
                                        </a>
                                    @endif
                                </td>
                            </tr>
