              ...
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                        ...
                        <form method="POST" action="addanggota" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            @csrf
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align">Nama Anggota <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" required="required" class="form-control @error('nama', 'post') is-invalid @enderror text-uppercase" name="nama" value="{{ old('nama') }}" autofocus/>
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="tgl" data-provide="datepicker"  class="form-control datepicker @error('tgllahir', 'post') is-invalid @enderror" name="tgllahir" value="{{ old('tgllahir') }}">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-1 col-sm-1 ">
                                    <input type="int" id="umur" class="form-control @error('umur', 'post') is-invalid @enderror" name="umur" readonly>
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <select class="form-control @error('pekerjaan', 'post') is-invalid @enderror" name="pekerjaan" value="{{ old('pekerjaan') }}" required="required">
                                        <option></option>
                                        <option>SMP</option>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="radio" name="tempek" id="Kangin" value="Kangin"> Kangin <br>
								    <input type="radio" name="tempek" id="Kauh" value="Kauh" /> Kauh
                                </div>
                            </div>
                            <div class="item form-group">
